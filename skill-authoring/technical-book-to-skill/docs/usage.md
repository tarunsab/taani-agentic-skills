---
description: "Every way to run /technical-book-to-skill: a single file, a folder, a glob, or a list of paths, with technical extraction modes, skill naming, and worked command examples."
...
```
/technical-book-to-skill <path-to-document-folder-or-glob>... [skill-name-slug]
```
...
/technical-book-to-skill ~/papers/paper1.pdf ~/notes/export.txt unified-research

# Process all supported files in a folder together
/technical-book-to-skill ~/workspace/project-docs/ project-knowledge

# Process files matching a glob pattern
/technical-book-to-skill "~/books/*.epub" my-library

# Update/fold new material into an existing skill folder
/technical-book-to-skill ~/articles/new-paper.pdf ~/.claude/skills/project-knowledge
```
